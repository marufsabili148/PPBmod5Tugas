        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl border border-white/40 mb-8">
          ...
          <div className="relative h-64 md:h-96 overflow-hidden">
            ...
            <div className="absolute top-4 right-4 z-10 flex gap-2">
              ...
              <button
                onClick={handleShare}
                className="p-3 rounded-full bg-white/90 backdrop-blur-sm shadow-lg text-slate-600 hover:text-blue-600 hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
